...
**Ptrade量化交易API的完整文档库** - 基于四个主要版本的详细对比分析和使用指南
...
Ptrade是由恒生电子开发的量化交易API平台，被多家券商采用并进行定制化部署。本项目整理了四个主要版本的完整文档，包括：

- **山西证券版本** (PBOXQT1.0V202202.03.000) - 最新完整功能版
...
| 券商 | 版本号 | 特点 | 推荐用途 |
|------|--------|------|----------|
| **山西证券** | V202 | 完整功能，最新版本，Python 3.11 | 专业交易，需要完整API |
